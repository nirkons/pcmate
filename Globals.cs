...
namespace PCMate
{
    class Globals
    {
        ...
        public static string[,] arrayOfUserIntentValueNames = new string[,] { { "Slow down", "turn on" }, { "Speed up", "turn on" }, { "Rewind", "turn on" }, { "Fast Forward", "turn on" }, { "Restart", "restart" }, { "Reload", "restart" }, { "Reboot", "restart" }, { "Reset", "restart" }, { "Set", "set" }, { "Mute", "mute" }, { "Shutdown", "shutdown" }, { "Power Off", "shutdown" }, { "Unlock", "unlock" }, { "Lock", "lock" }, { "Decrease", "decrease" }, { "Increase", "increase" }, { "Change", "change" }, { "Switch", "change" },  { "Adjust", "change" }, { "Turn Off", "turn off" }, { "Stop", "turn off" }, { "Pause", "turn off" }, { "Close", "turn off" }, { "Disable", "turn off" }, { "Deactivate", "turn off" }, { "Disconnect", "turn off" }, { "Switch Off", "turn off" }, { "Disconnect", "turn off" }, { "Turn On", "turn on" }, { "Play", "turn on" }, { "Launch", "turn on" }, { "Open", "turn on" }, { "Start", "turn on" }, { "Enable", "turn on" }, { "Reconnect", "turn on" }, { "Connect", "turn on" }, { "Activate", "turn on" }, { "Switch On", "turn on" } };
